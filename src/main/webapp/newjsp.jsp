<%-- 
    Document   : newjsp
    Created on : 12 nov. 2019, 15:47:00
    Author     : pedago
--%>
    ...
    <body>
		...
		<form method='GET'>
			...
			<input type="submit" value="Ajouter">
                ...
                <div><h4><c:if test="${erreur != null}">Impossible de supprimer ${erreur}, ce code est utilisé</c:if></h4></div>
		
		<div class="table">
			<div class="thead"><div class="td">Code</div><div class="td">Taux</div><div class="td">Action</div></div>
			<div class="tbody">
                        
                            <c:forEach var="ligne" items="${liste}">
                                <form class="tr" method="get">
					<div class="td"><input type="text" name="code" value="${ligne.code}" readonly/></div>
					<div class="td"><input name="taux" type="number" step="0.01" min="0.0" max="99.99" size="5" value="${ligne.taux}"/></div>
